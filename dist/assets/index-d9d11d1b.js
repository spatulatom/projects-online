(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function m(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(t){if(t.ep)return;t.ep=!0;const a=m(t);fetch(t.href,a)}})();const u=document.getElementById("light"),g=document.getElementById("dark"),d=document.getElementById("system"),f=document.getElementById("light-mobile"),y=document.getElementById("dark-mobile"),l=document.getElementById("system-mobile"),o=document.querySelector(".dropdown");function i(){u.classList.remove("text-cyan"),g.classList.remove("text-cyan"),d.classList.remove("text-cyan"),f.classList.remove("text-cyan"),y.classList.remove("text-cyan"),l.classList.remove("text-cyan")}"color-theme"in localStorage?localStorage.getItem("color-theme")==="dark"||!("color-theme"in localStorage)&&window.matchMedia("(prefers-color-scheme: dark)").matches?"mode-system"in localStorage?(i(),d.classList.add("text-cyan"),o.innerHTML=`<i
      id="dark"
    ...
    ></i>`,l.classList.add("text-cyan")):(i(),g.classList.add("text-cyan"),o.innerHTML=`<i
      id="dark"
      class="fa-solid fa-moon fa-xl cursor-pointer transition-all text-cyan"
    ></i>`,y.classList.add("text-cyan")):"mode-system"in localStorage?(i(),d.classList.add("text-cyan"),o.innerHTML=`<i
    ...
    >
      ...
      class="fa-solid fa-sun fa-xl cursor-pointer text-cyan"
    >
    </i>`,f.classList.add("text-cyan")):(i(),d.classList.add("text-cyan"),l.classList.add("text-cyan"),window.matchMedia("(prefers-color-scheme: dark)").matches?(o.innerHTML=`<i
      id="dark"
      class="fa-solid fa-moon fa-xl cursor-pointer transition-all text-cyan"
...
</div>`;s.innerHTML=m,console.log("DIV",s),F.appendChild(s)})}S();new T;H();G();
